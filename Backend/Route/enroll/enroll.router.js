...
router.get("/find-book-numbers/:admin/:branch", enrollController.getBookNumber);
router.post("/find-payment-slip/:admin/:branch", enrollController.getPaymentSlip);
router.post("/edit-book-numbers/:type/:admin/:branch", enrollController.editBookNumber);
