...
*THANK YOU FOR CHOOSING OUR INSTITUTE*.`;
            ...
            const url = `${process.env.WHATSAPP_URL}?number=91${immigration.mobileNumber}&type=text&message=${encodedMsg}&instance_id=${isBranch == 'Abrama, Mota Varachha' ? process.env.INSTANCE_ID_ABRAMA : isBranch == 'Sita Nagar' ? process.env.INSTANCE_ID_SITANAGER : process.env.INSTANCE_ID_ABC}&authorization=${process.env.ACCESS_TOKEN}`;
